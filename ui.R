                  ...
                  navbarPage(title = div(),
                             ...
                             tabPanel(div(img(src="LogoGrupo.svg",width="200px",height="86px")),
                                      tabsetPanel(
                                                 ...
                                                 sidebarLayout(
                                                   ...
                                                   mainPanel(
                                                     ...
                                                     fluidRow(
                                                       ...
                                                       column(fluidRow(
                                                         useShinyjs(),
                                                         h6(p("Differential expression (p-value < 0.05)",style="color:white;text-align:center"),style="background-color:black;border-radius: 8px"),
                                        ...
                                        ,tabPanel("Heatmap Gene Table", br(),
                                                sidebarPanel(
